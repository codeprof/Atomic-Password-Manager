...
const QString MainWindow::BaseWindowTitle = "Atomic"; //EDIT:
    ...
    , m_trayIcon(Q_NULLPTR)
{
    ...
    m_ui->actionEntryCopyPasswordEnc->setIcon(filePath()->icon("actions", "password-copy", false)); //EDIT:
    ...
    m_actionMultiplexer.connect(m_ui->actionEntryCopyPassword, SIGNAL(triggered()),
            SLOT(copyPassword()));
//EDIT:BEGIN
     m_actionMultiplexer.connect(m_ui->actionEntryCopyPasswordEnc, SIGNAL(triggered()),
            SLOT(copyPasswordEnc()));
...
void MainWindow::setMenuActionState(DatabaseWidget::Mode mode)
{
    ...
    if (inDatabaseTabWidget && m_ui->tabWidget->currentIndex() != -1) {
        ...
        case DatabaseWidget::ViewMode: {
            ...
            m_ui->actionEntryCopyPasswordEnc->setEnabled(singleEntrySelected && dbWidget->currentEntryHasPassword()); //EDIT:            
        ...
        m_ui->actionEntryCopyUsername->setEnabled(false);
        m_ui->actionEntryCopyPassword->setEnabled(false);
        m_ui->actionEntryCopyPasswordEnc->setEnabled(false); //EDIT:        
        m_ui->actionEntryCopyURL->setEnabled(false);
        m_ui->actionEntryCopyNotes->setEnabled(false);
        m_ui->menuEntryCopyAttribute->setEnabled(false);
